  ...
  return (
    <div className="flex gap-4 fade-in group">
      ...
      <div className="flex flex-col items-center">
        ...
        {!isFirst && <div className="w-px flex-1 bg-[#1e1e32] mt-1" />}
      </div>

      {/* Content */}
      <div className="flex-1 pb-5 min-w-0">
        {showDate && (
          <div className="font-mono text-[9px] text-[#475569] uppercase tracking-widest mb-1.5">
            {fmtDate(event.ts)}
          </div>
        )}
        <div className="flex items-start justify-between gap-3">
          <p className="text-[13px] text-[#e2e8f0] leading-snug">{event.title}</p>
          <span className="font-mono text-[10px] text-[#475569] shrink-0 mt-0.5">
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${active ? color + "55" : "#1e1e32"}`,
      }}
    >
  ...
  return (
    <div className="p-6 space-y-5 fade-in">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-[16px] font-semibold text-[#e2e8f0]">Context Timeline</h2>
